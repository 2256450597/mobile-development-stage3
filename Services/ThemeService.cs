...
public class ThemeService
{
    ...
    /// <summary>Returns the numeric scale factor for the current font size: 0.75 for Small, 1.5 for Large, and 1.0 for Medium.</summary>
    public double FontScale => CurrentFontSize switch
    {
        FontSizeOption.Small => 0.75,
        FontSizeOption.Large => 1.50,
        _ => 1.0
    };
